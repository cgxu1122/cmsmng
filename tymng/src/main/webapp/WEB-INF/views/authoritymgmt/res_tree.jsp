...
<script type="text/javascript">
    ...
    tree.loadXML("<%=basePath%>/res/loadres", function () {
        $(".standartTreeRow").css({"text-align": "left"});
    });
    tree.setOnClickHandler(function (index) {
        if (index == 1) {
            return;
        }
        parent.frames['mainFrame'].location = "<%=basePath%>/res/showdetail/" + tree.getSelectedItemId();
    });
</script>
</body>
</html>