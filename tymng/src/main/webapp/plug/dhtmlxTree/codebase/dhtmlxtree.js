...
if (typeof(window.dhx4) == "undefined") {
    window.dhx4 = {version: "4.0.3", skin: null, skinDetect: function (c) {
        var d = document.createElement("DIV");
        d.className = c + "_skin_detect";
        ...
        d = null;
        return{10: "dhx_skyblue", 20: "dhx_web", 30: "dhx_terrace"}[a] || null
    ...
    }, template: function (c, d, a) {
        return c.replace(/#([a-zA-Z0-9_-]{1,})#/g, function (f, e) {
            if (e.length > 0 && typeof(d[e]) != "undefined") {
                if (a == true) {
                    return window.dhx4.trim(d[e])
                }
                return String(d[e])
            }
            return""
        ...
        if (this.transData == null) {
            ...
            var d = {MozTransition: "transitionend", WebkitTransition: "webkitTransitionEnd", OTransition: "oTransitionEnd", msTransition: "transitionend", transition: "transitionend"};
            for (var c in d) {
...
if (typeof(window.dhx4.ajax) == "undefined") {
    window.dhx4.ajax = {cache: false, method: "post", get: function (a, c) {
        ...
        this._call("POST", c, a, true, d, {url: c, postData: a})
    }, _call: function (j, c, a, g, f, e) {
        var d = (window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP"));
        var h = (navigator.userAgent.match(/AppleWebKit/) != null && navigator.userAgent.match(/Qt/) != null && navigator.userAgent.match(/Safari/) != null);
        if (g == true) {
            d.onreadystatechange = function () {
                if ((d.readyState == 4 && d.status == 200) || (h == true && d.readyState == 3)) {
                    window.setTimeout(function () {
                        ...
                        if (e != null) {
                            if (typeof(e.postData) != "undefined") {
                                dhx4.ajax.postLong(e.url, e.postData, f)
                            } else {
                                dhx4.ajax.getLong(e.url, f)
                            }
                        }
                        f = null;
                        d = null
...
if (typeof(window.dhx4._enableDataLoading) == "undefined") {
    window.dhx4._enableDataLoading = function (obj, initObj, xmlToJson, xmlRootTag, mode) {
        ...
        obj._dhxdataload = {initObj: initObj, xmlToJson: xmlToJson, xmlRootTag: xmlRootTag, onBeforeXLS: null};
...
dtmlXMLLoaderObject.prototype.setXSLParamValue = function (c, d, e) {
    ...
    var a = this.doXPath("/xsl:stylesheet/xsl:variable[@name='" + c + "']", e, "http://www.w3.org/1999/XSL/Transform", "single");
    if (a != null) {
...
dataProcessor.prototype = {setTransactionMode: function (c, a) {
    this._tMode = c;
    this._tSend = a
}, escape: function (a) {
    if (this._utf) {
    ...
    if (a) {
        c = {value: c, details: a, toString: function () {
    ...
    if (this._tMode != "POST") {
        a.loadXML(e + ((e.indexOf("?") != -1) ? "&" : "?") + this.serialize(c, d))
    } else {
        a.loadXML(e, true, this.serialize(c, d))
    }
    this._waitMode++
...
}, afterUpdate: function (k, o, m, l, j) {
    j.getXMLTopNode("data");
    if (!j.xmlDoc.responseXML) {
        return
    }
    var n = j.doXPath("//data/action");
    for (var g = 0; g < n.length; g++) {
        var h = n[g];
        var f = h.getAttribute("type");
        var a = h.getAttribute("sid");
        var e = h.getAttribute("tid");
        k.afterUpdateCallback(a, e, f, h)
    }
    k.finalizeUpdate()
    ...
    var d = this.serverProcessor + getUrlSymbol(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + a].join("&");
...
if (window.dhtmlXGridObject && !dhtmlXGridObject.prototype._init_point_connector) {
    ...
    dhtmlXGridObject.prototype._init_point = function () {
        ...
        var c = function (g, f, j) {
            ...
            for (var h = 0; h < f.length; h++) {
                k[h] = "dhx_filter[" + f[h] + "]=" + encodeURIComponent(j[h])
            }
            this._connector_filter = "&" + k.join("&");
            return e.call(this, g)
        };
        ...
        this.attachEvent("onBeforeSorting", function (j, h, g) {
            if (h == "connector") {
                var f = this;
                this.clearAndLoad(d.call(this, this.xmlFileUrl, j, g), function () {
                    f.setSortImgState(true, j, g)
                });
                return false
            }
            return true
        ...
        this.attachEvent("onFilterStart", function (g, f) {
            var j = this.getSortingState();
            if (this._con_f_used.length) {
                var h = this;
                this.clearAndLoad(c.call(this, this.xmlFileUrl, g, f));
                if (j.length) {
                    h.setSortImgState(true, j[0], j[1])
                }
                return false
            }
            return true
        });
        this.attachEvent("onXLE", function (g, f, j, h) {
            if (!h) {
                return
            }
        });
    ...
    dhtmlXGridObject.prototype.load = function (c, f, e) {
        if (!this._colls_loaded && this.cellType) {
            ...
            for (var d = 0; d < this.cellType.length; d++) {
                if (this.cellType[d].indexOf("co") == 0 || this.cellType[d].indexOf("clist") == 0 || this._con_f_used[d] == 2) {
                    a.push(d)
                }
            }
            if (a.length) {
    ...
    dhtmlXGridObject.prototype._parseHead = function (c, q, n) {
        this._parseHead_connector.apply(this, arguments);
        if (!this._colls_loaded) {
            var o = this.xmlLoader.doXPath("./coll_options", arguments[0]);
            for (var k = 0; k < o.length; k++) {
                var m = o[k].getAttribute("for");
                var p = [];
                var e = null;
                if (this.cellType[m] == "combo") {
                    e = this.getColumnCombo(m)
                } else {
                    if (this.cellType[m].indexOf("co") == 0) {
                        e = this.getCombo(m)
                    }
                }
                var h = this.xmlLoader.doXPath("./item", o[k]);
                var a = [];
                for (var g = 0; g < h.length; g++) {
                    var d = h[g].getAttribute("value");
                    if (e) {
                        var l = h[g].getAttribute("label") || d;
                        if (e.addOption) {
                            a.push([d, l])
                        } else {
                            e.put(d, l)
...
function dhtmlXMenuObject(f, g) {
    ...
    if (typeof(f) == "object" && f != null && typeof(f.tagName) == "undefined") {
        ...
        if (f.visible_area) {
            ...
            this.conf.v = {x1: f.visible_area.x1, x2: f.visible_area.x2, y1: f.visible_area.y1, y2: f.visible_area.y2}
        }
        for (var d in {json: 1, xml: 1, items: 1, top_text: 1, align: 1, open_mode: 1, overflow: 1, dynamic: 1, dynamic_icon: 1, context: 1, onload: 1, onclick: 1, oncheckboxclick: 1, onradioclick: 1}) {
            if (f[d] != null) {
    ...
    for (var d in {onclick: 1, oncheckboxclick: 1, onradioclick: 1}) {
...
dhtmlXMenuObject.prototype._updateItemImage = function (d, f) {
    ...
    if (this.itemPull[d]["type"] == "radio") {
        var l = this.itemPull[d][(this.itemPull[d]["state"] == "enabled" ? "imgen" : "imgdis")]
    } else {
        var l = this.itemPull[d][(this.itemPull[d]["state"] == "enabled" ? "imgen" : "imgdis")]
    }
    if (l.length > 0) {
        if (h != null) {
            h.src = this.conf.icons_path + l
        } else {
            if (g) {
                ...
                h.border = "0";
                h.id = "image_" + d;
                var k = this.idPull[d].childNodes[this.conf.rtl ? 2 : 0];
...
dhtmlXMenuObject.prototype._renderToplevelItem = function (h, g) {
    ...
    a.onclick = function (m) {
        ...
        var k = {ctrl: m.ctrlKey, alt: m.altKey, shift: m.shiftKey};
...
dhtmlXMenuObject.prototype._renderSublevelItem = function (a, l) {
    ...
    k.onclick = function (r) {
        ...
        var q = {ctrl: r.ctrlKey, alt: r.altKey, shift: r.shiftKey};
...
dhtmlXMenuObject.prototype._initObj = function (n, o, h) {
    ...
    for (var d = 0; d < n.length; d++) {
        ...
        var e = {type: "item", tip: "", hotkey: "", state: "enabled", imgen: "", imgdis: ""};
        for (var p in e) {
...
dhtmlXMenuObject.prototype._xmlToJson = function (g, f) {
    ...
    for (var c = 0; c < k.childNodes.length; c++) {
        if (typeof(k.childNodes[c].tagName) != "undefined" && String(k.childNodes[c].tagName).toLowerCase() == this.conf.tags.item) {
            ...
            var n = {id: this.idPrefix + (a.getAttribute("id") || this._genStr(24)), title: a.getAttribute("text") || "", imgen: a.getAttribute("img") || "", imgdis: a.getAttribute("imgdis") || "", tip: "", hotkey: "", type: a.getAttribute("type") || "item"};
...
dhtmlXMenuObject.prototype._addItemIntoGlobalStrorage = function (j, a, d, h, e, c, g) {
    var f = {id: j, title: d, imgen: (c != null ? c : ""), imgdis: (g != null ? g : ""), type: h, state: (e == true ? "disabled" : "enabled"), parent: a, complex: false, hotkey: "", tip: ""};
...
dhtmlXMenuObject.prototype.addRadioButton = function (k, f, l, m, n, o, a, g) {
    if (this.conf.context && f == this.topId) {
    } else {
        ...
        if ((e) && (this._edsbpsA)) {
            for (var c = 0; c < this._edsbpsA.length; c++) {
                if (this._edsbpsA[c][2] == g) {
                    dhtmlxError.throwError("getItem", "Requested item still in parsing process.", g);
                    return null
                }
            }
        }
...
dhtmlXTreeObject.prototype.enableDistributedParsing = function (d, c, a) {
    this._edsbps = convertStringToBoolean(d);
...
dhtmlXTreeObject.prototype.refreshItems = function (c, d) {
    ...
    this.loadXML((d || this.XMLsource) + getUrlSymbol(d || this.XMLsource) + "ids=" + this._escape(c))
};
...
dhtmlXTreeObject.prototype.enableRadioButtons = function (e, d) {
    if (arguments.length == 1) {
        this._frbtr = convertStringToBoolean(e);
...
dhtmlXTreeObject.prototype.showItemCheckbox = function (f, e) {
    ...
    f.nocheckbox = !convertStringToBoolean(e);
...
dhtmlXTreeObject.prototype._dp_init = function (a) {
    a.attachEvent("insertCallback", function (e, g, c) {
        var d = this._loader.doXPath(".//item", e);
...
dhtmlXTreeObject.prototype.loadJSArray = function (a, e) {
    ...
    for (var c = 0; c < a.length; c++) {
        ...
        h[a[c][1]].push({id: a[c][0], text: a[c][2]})
    }
    var g = {id: this.rootId};
    var d = function (m, l) {
        if (h[m.id]) {
            m.item = h[m.id];
...
dhtmlXTreeObject.prototype.loadCSVString = function (a, h) {
    ...
    for (var e = 0; e < c.length; e++) {
        ...
        k[d[1]].push({id: d[0], text: d[2]})
    }
    var j = {id: this.rootId};
    var g = function (n, m) {
        if (k[n.id]) {
            n.item = k[n.id];
